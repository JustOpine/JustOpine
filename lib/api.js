...
module.exports = {
            ...
            if(err){
                ...
                client.hmset("login", userInfo.username, loginInformation, function(err, data) {
                    if(err){
                        ...
                        client.hmset(key2, finalID, userInformation, function(error, data) {
                            if(err){
            ...
            if(err){
                ...
                client.zrange(setKey, 0, -1, function(err, previousResponses){
                    if(err){
                        ...
                        if(!this.responseAlreadyExists(previousResponses, userID)){
                            // no previous responses found for this user
    ...
    responseAlreadyExists: function(previousResponses, userID, callback){
        ...
        console.log("length", previousResponsesLength);
