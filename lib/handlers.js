				...
				api.getAssignmentsForOneClass(teacherID, className, function(err, assignments){
					...
					if (err) {
						...
						for (var key in assignments) {
							...
							assembledData += "<a href='/assignment2/" + assignments[key].class + "/" + assignments[key].assignmentID + "'><div class='dashboard-assignment'><div class='dashboard-image'><img class='opinion-piece-image' src='" + assignments[key].image + "'></div><h2>" + assignments[key].title + "</h2><p>" + textExtract + "...</p><div class='tag'>" + assignments[key].class + "</div><div class='tag'>" + assignments[key].category + "</div></div></a>";
						}
