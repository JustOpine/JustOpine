...
module.exports = {
    ...
    store : function (deets, passhash, id, callback) {
        ...
        var key = 'teacher:' + id;
        this.client.hmset(key, 'firstname', deets.firstname, 'surname', deets.surname,
                                'username', deets.username, 'password', passhash,
                                'isAdmin', deets.isAdmin, 'isTeacher', deets.isTeacher, function(err, data) {
            if(err){
                callback(err, null);
            }
        });
