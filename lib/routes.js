...
var routes = [
        ...
        {
            method: 'GET', path: '/pupils', handler: handlers.pupils
        },
        {
            method: 'GET', path: '/assignment2', handler: handlers.assignmentPupil
        },
        {
            method: 'GET', path: '/assignment1', handler: handlers.assignmentTeacher
        },
        {
