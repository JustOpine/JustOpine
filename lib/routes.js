...
var routes = [
    ...
    {
        method: 'GET', path: '/dash1', handler: handlers.dashboardPupil
    },
    {
        method: 'GET', path: '/dash2', handler: handlers.dashboardTeacher
    },
    {
        method: 'GET', path: '/dash3', handler: handlers.dashboardAdmin
    },
    {
